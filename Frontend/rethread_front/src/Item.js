...
function Item() {
    ...
    const handleAddToCart = () => {
        axios.get("http://localhost:10000/addCart/"+"ak23amit@gmail.com"+"/"+product.product_name)
        .then((response) => {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`http://localhost:10000/product-by-id/${id}`); // Adjust the endpoint URL as per your backend
